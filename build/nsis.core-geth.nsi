...
# 1. install core-geth for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for core-geth
# 5. create core-geth, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since core-geth is installed global
