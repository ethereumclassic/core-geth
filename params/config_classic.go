...
var (
	...
	ClassicChainConfig = &coregeth.CoreGethChainConfig{
		...
		// MESS (ECBP-1100) is an operator option, set with the --mess flag. The
		// bundled configuration ships it off from the Spiral block, the default
		// ECBP-1110 recommends. Neither is a consensus rule: the setting only
